...
コード [`07_module_ex1.py`](07_module_ex1.py) は [score_A.csv](score_A.csv) を読み込んで点でプロットするものです．
...
データ [score_A.csv](score_A.csv) と [score_B.csv](score_B.csv) の平均，分散，標準偏差，中央値，最頻値をそれぞれ計算してみましょう．
