...
まずはプロットするデータを読み込みます．[.csv]()をダウンロードして，読み込めるようにGooge Driveに配置してください．

```Python
'''
データの読みこみ
'''
input_file = '.csv'	# 読み込むファイル名
...
コード [`07_module_ex1.py`](07_module_ex1.py) は [.csv]() を読み込んで点でプロットするものです．
...
コード [`07_module_ex1.py`](07_module_ex1.py) を改良し，ヒストグラムをプロットしましょう．
...
データ [.csv]() の平均，分散，標準偏差，中央値，最頻値を計算してみましょう．
